...
| **P5.5** | Backup & git | ✅ done (2026-08-24) — git repo initialized (commit `2e4530e`, 35 files, ~12.5k lines); ⬇ backup / ⬆ restore buttons in the map footer export/import ALL localStorage data (progress, notes, forged questions, Arabic cache, theme — API keys deliberately excluded) as a dated JSON file; round-trip tested against a simulated full wipe |
